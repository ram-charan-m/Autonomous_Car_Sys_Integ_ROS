...
class TLDetector(object):
    ...
    def waypoints_cb(self, waypoints):
        ...
        if not self.waypoints_2d: # in case of first message
    ...
    def get_closest_waypoint(self, x, y): # same approach as in waypoint_updater
...
#         # After implementing classsifier
    ...
    def process_traffic_lights(self):
        ...
        if self.pose:
            ...
            for i, light in enumerate(self.lights):
                ...
                # Find closest stop line wp idx
                d = temp_wp_idx - car_wp_idx
                # if traffic light ahead and within wp
                if 0 <= d < diff:
                    diff = d
                    closest_light = light
